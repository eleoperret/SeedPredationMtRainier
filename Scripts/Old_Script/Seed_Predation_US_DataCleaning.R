...
#Name of final cleaned dataset : data_cleaned_2 (for seeds), tree growth data (all tree information for the selected site and year), tree_trap_5m (all tree that are in 5m of my cameras), All tree data (all the data I have on the trees + only the trees that are around 5m of my cameras)
#Name of original datasets: SeedPredation_First_week, Cleaned_mapping_2017 Rainier, Cleaned_tree_growth_2017 Rainier, seed_data
...
# Selecting only the sites I need from the tree Rainier data (geographic position of the trees)
...
save(tree_growth_data_2017_sites, file = "C:/Users/eperret/polybox - Eleonore Perret (eleonore.perret@usys.ethz.ch)@polybox.ethz.ch/phD/PhD/R/Seed_predation/Seed_predation_US_Github/Seed_predation_US_Github2/Datasets/tree_growth_data_2017_sites.RData")
